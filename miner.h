...
struct device_drv {
    ...
    bool    (*hw_reset)(struct cgpu_info *);
    bool    (*stop_miner)(struct cgpu_info *);
    bool    (*start_miner)(struct cgpu_info *);
#endif
...
#if defined(USE_LTCTECH) || defined(USE_COINFLEX)
extern char         *opt_device_options;

extern enum cl_kernels kernel;

extern int          workid_mismatch;
extern char         *drv_name;
extern char     *drv_ver;
extern char     *drv_date;
#endif 
...
extern int64_t total_accepted, total_rejected;
